...
Toast(params:=0) {
	...
	local message, lifespan, position, fontSize, fontWeight, fontColor, backgroundColor, backgroundAlpha, GUIHandleName, GUIX, GUIY, GUIWidth, GUIHeight, NewX, NewY
	...
	backgroundAlpha := params.backgroundAlpha ? params.backgroundAlpha : 0
